            ...
            <div class="d-flex">
                ...
                <div class="navbar-brand-box horizontal-logo">
                    <a href="{{ route('dashboard.index') }}" class="logo logo-dark">
                        ...
                        <span class="logo-lg">
                            <img src="{{ asset('storage/' . setting('site.logo_dark')) }}" alt="" height="17">
                        </span>
                    </a>
                ...
                <form class="app-search d-none d-md-block">
                    <div class="position-relative">
                        <input type="text" class="form-control" placeholder="{{ __('Search on products') }}" autocomplete="off" id="search-options" value="" required>
                        ...
                        <span class="d-flex align-items-center">
                            ...
                            <span class="text-start ms-xl-2">
                                ...
                                <span class="d-none d-xl-block ms-1 fs-12 user-name-sub-text">
                                    {{ implode(' / ', auth()->user()->getTranslatedRoleNames(app()->getLocale())) }}
                                </span>
                            </span>
                        </span>
                    </button>
